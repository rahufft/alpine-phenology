...
#error...GDD object not found. It does show it as a numeric variable in bloom, but not able to run it    
Didn't you just add GDD as a column so it's not a variable on it's own, it's bloom$GDD   
